...
function search() { 
    ...
    let sorterRecipes = filteredRecipes.sort(compareRecipes);

    // clear out any previous content in the recipeContainer before rendering the new filtered recipes
    recipeContainer.innerHTML = '';
    sorterRecipes.forEach(function(recipe){
      renderRecipe(recipe);
    })
